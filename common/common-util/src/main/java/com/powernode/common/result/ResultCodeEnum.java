package com.powernode.common.result;
...
public enum ResultCodeEnum {
    ...
    NO_START_SERVICE( 217, "未开启配送服务，不能更新位置信息"),
    DRIVER_START_LOCATION_DISTION_ERROR( 217, "距离配送起始点1公里以内才能确认"),
    DRIVER_END_LOCATION_DISTION_ERROR( 217, "距离配送终点2公里以内才能确认"),
    IMAGE_AUDITION_FAIL( 217, "图片审核不通过"),
    AUTH_ERROR( 217, "认证通过后才可以开启配送服务"),
    ...
    WX_CODE_ERROR(260,"微信授权失败"),

    XXL_JOB_ERROR(270,"xxl失败"),
    FACE_FAIL(280,"人脸识别失败"),
    FILE_ERROR(290,"上次minio失败")
    ;
